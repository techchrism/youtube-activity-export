...
import PlaylistTable from './components/PlaylistsTable'
import { ParsedZip } from './parse/parseZip';

const App: Component = () => {
    const [parsedZip, setParsedZip] = createSignal<ParsedZip | undefined>(undefined)

    return (
        <div class="hero my-20 bg-base-200 text-lg">
            <div class="hero-content text-center">
                <div class="max-w-2xl">
                    ...
                    <div class="divider" />
                    <FileUpload onParse={setParsedZip}/>

                    <Show when={parsedZip()}>
                        {(parsed) => <>
                            <div class="divider" />
                            <PlaylistTable parsedZip={parsed()} />
                        </>}
                    </Show>
                </div>
            </div>
